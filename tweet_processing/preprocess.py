...
def normalize_text(text):
	...
	for i in range(0, len(text)):
		text[i] = text[i].encode("utf-8").lower()
...
def create_preprocessed_file(filename):
	...
	if(filename in {"new_data/merged.csv"}):
		print("Merged condition true")
		df1 = pandas.read_csv("new_data/conservative-preprocessed.csv")
		df2 = pandas.read_csv("new_data/gap-preprocessed.csv")
		df3 = pandas.read_csv("new_data/impact-preprocessed.csv")
		df4 = pandas.read_csv("new_data/leader-preprocessed.csv")
		df5 = pandas.read_csv("new_data/marriage-preprocessed.csv")
		df6 = pandas.read_csv("new_data/maternity-preprocessed.csv")
		df7 = pandas.read_csv("new_data/politicians-preprocessed.csv")
		df8 = pandas.read_csv("new_data/talkpay-preprocessed.csv")
